...
import { specialtyDict } from './specialties.js';
...
const specialtyOptions = specialtyDict.map(function (value, index) {
        ...
        <>
            ...
            <Form action='POST' onSubmit={handleUserUpdate} >
                ...
                <Form.Select
                    ...
                    id='specialty'
                    onChange={handleChange}
                    defaultValue={authSelector.specialty}
                    required
